            ...
            <div class="lead-tabel">
                <table width="90%" align="center">
                    ...
                    <tr>
                        ...
                        <td align="right"><b>{{ $user->skor }}</b> <img src="img/star.png" alt="" width="25px" align="center" class="star"><a href="{{ route('admin.score', $user) }}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    </tr>
                    @endforeach
                </table>
            </div>
