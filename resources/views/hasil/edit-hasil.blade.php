            ...
            <div class="body">
                <form method="POST" action="{{ route('tugas.editstore', ['tugasId' => $tugas->id]) }}">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="deskripsi" id="" cols="30" rows="10" id="deskripsi" placeholder="Masukan deksripsi/penjelasan dari hasil tugas yang di berikan" name="deskripsi" rows="3" @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ old('deskripsi') }}" required autocomplete="deskripsi">{{ old('deskripsi', $tugas->hasilTugas->deskripsi) }}</textarea>
                        @error('deskripsi')
